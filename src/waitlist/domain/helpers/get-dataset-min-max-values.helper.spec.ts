    ...
    const dataset: PatientFacilityModel[] = [
      {
        ...
        name: 'Samir Pacocha',
        location: { latitude: 46.711, longitude: -63.115 },
    ...
    const dataset: PatientFacilityModel[] = [
      {
        ...
        name: 'Mr. Brenna Funk',
        location: { latitude: 87.5657, longitude: 1.3006 },
      ...
      },
      {
        ...
        name: 'Kevon Friesen',
        location: { latitude: 14.7807, longitude: -72.7663 },
      ...
      },
      {
        ...
        name: 'Tre Denesik',
        location: { latitude: -11.7897, longitude: 148.3948 },
